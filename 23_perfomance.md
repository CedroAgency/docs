...
Используйте **assetsset** для выбора необходимого изображения под нужное разрешение.

```html
<img assets="/images/example.jpg" assetsset="/images/example-retina.jpg 2x" alt="image">
```
